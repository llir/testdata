...
mv "test/Assembler/datalayout-alloca-addrspace-mismatch-0.ll" "test/Assembler/datalayout-alloca-addrspace-mismatch-0.ll.x"
mv "test/Assembler/datalayout-alloca-addrspace-mismatch-1.ll" "test/Assembler/datalayout-alloca-addrspace-mismatch-1.ll.x"
mv "test/Assembler/datalayout-alloca-addrspace-mismatch-2.ll" "test/Assembler/datalayout-alloca-addrspace-mismatch-2.ll.x"
...
mv "test/CodeGen/AMDGPU/invalid-alloca.ll" "test/CodeGen/AMDGPU/invalid-alloca.ll.x"
...
mv "test/Verifier/Mips/intrinsic-immarg.ll" "test/Verifier/Mips/intrinsic-immarg.ll.x"
...
mv "test/Verifier/gcroot-alloca.ll" "test/Verifier/gcroot-alloca.ll.x"
mv "test/Verifier/gcroot-meta.ll" "test/Verifier/gcroot-meta.ll.x"
mv "test/Verifier/gcroot-ptrptr.ll" "test/Verifier/gcroot-ptrptr.ll.x"
...
mv "test/Verifier/token1.ll" "test/Verifier/token1.ll.x"
...
mv "test/Other/scalable-vector-struct.ll" "test/Other/scalable-vector-struct.ll.x"
...
mv "test/Verifier/invalid-statepoint2.ll" "test/Verifier/invalid-statepoint2.ll.x"
...
mv "test/Verifier/unsized-types.ll" "test/Verifier/unsized-types.ll.x"
